trigger propertyContractBreakTrigger on Property_Contract_Break__c(after insert, after update, after delete) {
/********************************************************************************
...
********************************************************************************/
    ...
    // Delegate responsibility to the Property Contract Break Trigger Handler Class.
    PropertyContractBreakTriggerHandler handler = new PropertyContractBreakTriggerHandler(Trigger.isExecuting, Trigger.size);
