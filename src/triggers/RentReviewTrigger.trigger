trigger RentReviewTrigger on Rent_Review__c (after insert, after update, after delete) {
...
********************************************************************************/
    ...
    RentReviewTriggerHandler handler = new RentReviewTriggerHandler(Trigger.isExecuting, Trigger.size);
