trigger PropertyInsuranceTrigger on Property_Insurance__c (after insert, after update, after delete){
/********************************************************************************
...
********************************************************************************/
    ...
    PropertyInsuranceTriggerHandler handler = new PropertyInsuranceTriggerHandler (Trigger.isExecuting, Trigger.size);
