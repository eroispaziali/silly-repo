trigger propertyRentTrigger on Property_Rent__c(after insert, after update, after delete) {
/********************************************************************************
...
********************************************************************************/
    ...
    // Delegate responsibility to the Property Rent Trigger Handler Class.
    PropertyRentTriggerHandler handler = new PropertyRentTriggerHandler(Trigger.isExecuting, Trigger.size);
